            ...
            <div className="bg-[#F7F9FD] rounded-[20px] h-[658px] w-full relative ">
                ...
                <div className=" p-5" >
                    <div>
                        ...
                        <div className="Email p-3 text-black">Email Address<span className="font-bold dark:text-red-500">*</span></div>
                        <input type="text" placeholder="Username" value={email} onChange={(e)=>setEmail(e.target.value)} className="p-3 bg-white w-full rounded-lg "/>
                    ...
                    {/* <div className="result text-red-500 text-center font-bold">{handleLogin}</div> */}
                    
                    <div className="flex pt-2 justify-end"><a href="ForgetPassword" className="text-[#6B40ED]">Forgot Password?</a></div>
                    <div className="pt-10"><button type="submit" onClick={handleLogin} className="bg-[#6B40ED] p-4 text-white w-full rounded-full ">Login</button></div>
                </div>
            </div>
        </div>
    </div>
